        ...
        return (
          <div
            ...
            <div className='flex items-center gap-3 min-w-35'>
              ...
              {/* Title */}
              <span className='font-medium text-gray-800 dark:text-gray-100 text-[14px]'>
                {orderId}
              </span>
            </div>
            ...
            <div className='flex-1 min-w-0 space-y-2'>
              ...
              {/* Lower metadata */}
              <div className='flex items-center justify-between text-xs text-gray-600 dark:text-gray-400 flex-wrap gap-3'>

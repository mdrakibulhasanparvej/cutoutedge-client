        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="space-y-3">
            <div className="flex gap-3 p-3 bg-amber-50 rounded-lg">
              ...
              <div>
                <p className="font-medium">High priority orders pending</p>
            ...
            <div className="flex gap-3 p-3 bg-red-50 rounded-lg">
              ...
              <div>
                <p className="font-medium">QC-2 rejection rate</p>
                <p className="text-sm text-gray-600">12.4% (above threshold)</p>
              </div>
            </div>
          </div>
        </div>
